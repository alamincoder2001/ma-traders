...
", [date('Y-m-d'), $this->session->userdata('BRANCHid')])->row()->total_amount;
...
$todayPayment = $this->db->query("
						select 
						ifnull((
							select sum(ifnull(pm.PurchaseMaster_PaidAmount, 0)) 
							from tbl_purchasemaster pm
							where pm.status = 'a'
							and pm.PurchaseMaster_BranchID = " . $this->session->userdata('BRANCHid') . "
							and pm.PurchaseMaster_OrderDate = '" . date('Y-m-d') . "'
						), 0) +
						ifnull((
							select sum(ifnull(cp.CPayment_amount, 0)) 
							from tbl_customer_payment cp
...
if ($module == 'dashboard' or $module == '') { ?>
	<div class="row">
		<div class="col-md-12 col-xs-12">
			...
			<div class="col-md-10 col-md-offset-1" style="border-bottom: 1px dashed red;
    margin-bottom: 10px;
    padding-bottom: 10px;">
				<div class="col-md-4 mobileResponsive">
					<div class="widgets" style="border-top: 10px solid #1c8dff;">
						...
						<div class="widget-content">
							...
							<div class="widget-value"><?php echo $this->session->userdata('Currency_Name'); ?> <?php echo $todays_sale; ?></div>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="widgets" style="border-top: 10px solid rgb(102, 102, 51);">
						<div class="widget-icon" style="background-color: rgb(102, 102, 51);text-align:center;">
							<i class="fa fa-shopping-cart fa-2x"></i>
						</div>
	
						<div class="widget-content">
							<div class="widget-text">Today's Collection</div>
							<div class="widget-value"><?php echo $this->session->userdata('Currency_Name'); ?> <?php echo $todaysCollection; ?></div>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="widgets" style="border-top: 10px solid rgb(255, 128, 0);">
						<div class="widget-icon" style="background-color: rgb(255, 128, 0);text-align:center;">
							<i class="fa fa-shopping-cart fa-2x"></i>
						</div>
	
						<div class="widget-content">
							<div class="widget-text">Today's Payment</div>
							<div class="widget-value"><?php echo $this->session->userdata('Currency_Name'); ?> <?php echo $todayPayment; ?></div>
						</div>
					</div>
				</div>
			</div>
